...
const Communication_notes = () => {
  useEffect(() => {
    const contentContainer = document.querySelector(".communication_content");
    const backgroundImg = document.querySelector(
      ".communication_background_img"
    );
    ...
    const observerCallback = (entries, observer) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          ...
          backgroundImg.classList.add("communication_view_bg_animate");
        } else {
          contentContainer.classList.remove("animate-left-to-right");
          backgroundImg.classList.remove("communication_view_bg_animate");
        }
      });
    };
  ...
  return (
    <div className="communication_container">
      <div className="communication_content_container">
        <div className="communication_arrow">
          <svg
            className="arrow_img"
            width="24px"
            height="70px"
        ...
        <div className="communication_content">
          <div className="communication_main_content">
            <div className="communication_header_txt">Trust</div>

            <h2 className="communication_header_description">
              <span>We're built on relationships.</span>
            </h2>

            <div className="communication_description_points">
              <ul>
                <li>
      ...
      <div className="communication_background_img">
        <div className="communication_background_gradient"></div>
        <img
          loading="lazy"
          className="mcc__background__src background__src"
          src="https://www.align.com/hubfs/Align%20Theme/New%20Hero%20Images/hero-4.jpg"
          alt
...
export default Communication_notes;
