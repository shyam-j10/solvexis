...
const Expertise = () => {
  useEffect(() => {
    const contentContainer = document.querySelector(".expertise_content");
    const backgroundImg = document.querySelector(".expertise_background_img");
    const observerOptions = { root: null, rootMargin: "0px", threshold: 0.1 };
    const observerCallback = (entries, observer) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          contentContainer.classList.add("animate-left-to-right");
          backgroundImg.classList.add("expertise_view_bg_animate");
        } else {
          contentContainer.classList.remove("animate-left-to-right");
          backgroundImg.classList.remove("expertise_view_bg_animate");
        }
      });
    };
  ...
  return (
    <div className="expertise_container">
      <div className="expertise_content_container">
        <div className="expertise_arrow">
          <svg
            className="arrow_img"
            width="24px"
            height="70px"
        ...
        <div className="expertise_content">
          <div className="expertise_main_content">
            <div className="expertise_header_txt">Trust</div>

            <h2 className="expertise_header_description">
              <span>We're built on relationships.</span>
            </h2>

            <div className="expertise_description_points">
              <ul>
                <li>
      ...
      <div className="expertise_background_img">
        <div className="expertise_background_gradient"></div>
        <img
          loading="lazy"
          className="mcc__background__src background__src"
          src="https://www.align.com/hubfs/Align%20Theme/New%20Hero%20Images/hero-6.jpg"
          alt
