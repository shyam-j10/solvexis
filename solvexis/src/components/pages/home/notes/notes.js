...
const Notes = () => {
  useEffect(() => {
    const contentContainer = document.querySelector(".notes_content");
    const backgroundImg = document.querySelector(".notes_background_img");
    const observerOptions = { root: null, rootMargin: "0px", threshold: 0.1 };
    const observerCallback = (entries, observer) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          contentContainer.classList.add("animate-left-to-right");
          backgroundImg.classList.add("notes_view_bg_animate");
        } else {
          contentContainer.classList.remove("animate-left-to-right");
          backgroundImg.classList.remove("notes_view_bg_animate");
        }
      });
    };
    ...
    <div className="notes_container">
      <div className="notes_content_container">
        ...
        <div className="notes_content">
          <div className="notes_main_content">
            <div className="notes_header_txt">Trust</div>

            <h2 className="notes_header_description">
              <span>We're built on relationships.</span>
            </h2>

            <div className="notes_description_points">
              <ul>
                <li>
      ...
      <div className="notes_background_img">
        <div className="notes_background_gradient"></div>
        <img
          loading="lazy"
          className="mcc__background__src background__src"
          src="https://www.align.com/hubfs/Align%20Theme/New%20Hero%20Images/hero-2.jpg"
          alt
